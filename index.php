...
$permissions = ['about','age_range','education','favorite_athletes','favorite_teams','gender','location','relationship_status','sports','religion','work','books{"about","name","description","category"}','events{"name","description","category"}','games{"name","about","description","category"}','likes{"name","about","description","category"}','movies{"about","name","category","description"}','music{"about","name","category","description"}','posts{"description","story","message"}','tagged_places','television{"about","description","category","name"}']; // Optional permissions
